...
| VOXI / Vodafone UK | [打开 VOXI / Vodafone UK 导入页](https://lurnd.github.io/Wi-Fi-Calling-Rules/#voxi-vodafone-uk) | [voxi-vodafone-uk.conf](configs/voxi-vodafone-uk.conf) | [voxi-vodafone-uk.list](rules/voxi-vodafone-uk.list) |
...
- 导入页使用 [Shadowrocket URL Scheme](https://github.com/LOWERTOP/Shadowrocket/wiki) `shadowrocket://config/add/{url}`，由用户点击链接直接唤起 App。导入页托管在本仓库的 GitHub Pages 上。
